...
const NAV_CONFIG = {
  groups: [
    {
      label: 'Overview',
      items: [
        { page: 'dashboard',       icon: '▸', label: 'Dashboard',       title: 'Dashboard',       breadcrumb: 'System overview' },
    ...
    },
    {
      label: 'Communication',
      items: [
        { page: 'conference-email', icon: '▸', label: 'Email Resend',       title: 'One-Click Email Resend', breadcrumb: 'GR & Conference invite resend' },
  ...
  external: [
    ...
    { page: 'video-editor', href: 'https://charter-constraints-civil-loved.trycloudflare.com', icon: '▸', label: 'Video Editor' },
  ],
};
