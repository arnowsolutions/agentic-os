...
const NAV_CONFIG = {
  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        { page: 'compliance',        icon: '▸', label: 'Compliance',        title: 'Compliance Dashboard', breadcrumb: 'Attendance, evals & GME metrics' },
      ],
      sections: [
        {
          label: 'Rotation ops', collapsed: true, items: [
            ...
            { page: 'call-schedule-pdf',      icon: '▸', label: 'Schedule PDF',     title: 'Call Schedule PDF', breadcrumb: 'Generate and email PDFs' },
            { page: 'cal-new',                icon: '▸', label: 'Calendar (new)',   title: 'Calendar (new)',   breadcrumb: 'Next-gen calendar view' },
        ...
        {
          label: 'GME & evals', collapsed: true, items: [
            { page: 'eval-portal',  icon: '▸', label: 'Eval Portal',   title: 'Eval Portal',   breadcrumb: 'CMS evaluation forms' },
            { page: 'eval-dashboard', icon: '▸', label: 'Eval Dashboard', title: 'Eval Dashboard', breadcrumb: 'Completion stats & charts' },
            { page: 'gme-tracker',  icon: '▸', label: 'GME Tracker',   title: 'GME Reimbursement Tracker', breadcrumb: 'Education fund management' },
            { page: 'gme-detail',   icon: '▸', label: 'GME Deep Dive', title: 'GME Deep Dive', breadcrumb: 'Fund usage breakdown' },
          ]
        },
        {
          label: 'Collection & comms', collapsed: true, items: [
            ...
            { page: 'grand-rounds',      icon: '▸', label: 'Grand Rounds',     title: 'Grand Rounds',      breadcrumb: 'Event feed' },
            { page: 'conference-email',  icon: '▸', label: 'Conference Email', title: 'Conference Email',  breadcrumb: 'Conference invite builder' },
            { page: 'chief-meetings',    icon: '▸', label: 'Chief Meetings',   title: 'Chief Meetings',    breadcrumb: 'Chief meeting rows & invites' },
    ...
    },
    {
      ...
      items: [
        ...
        { page: 'ai-builder',     icon: '▸', label: 'AI Builder',   title: 'AI Builder',        breadcrumb: 'Google Antigravity · Gemini' },
      ],
      sections: [
        {
          label: 'Media & prompts', collapsed: true, items: [
            { page: 'google-studio',      icon: '▸', label: 'Google Studio',   title: 'Google Dev Studio', breadcrumb: 'Apps Script editor' },
            { page: 'prompt-tools-image', icon: '▸', label: 'Image Builder',   title: 'Image Prompt Builder', breadcrumb: 'Build image prompts' },
            { page: 'prompt-tools-video', icon: '▸', label: 'Video Builder',   title: 'Video Prompt Builder', breadcrumb: 'Build video prompts' },
            { page: 'image-gallery',      icon: '▸', label: 'Image Gallery',   title: 'Image Gallery',     breadcrumb: 'Design mockups & images' },
            { page: 'social-media-hub',   icon: '▸', label: 'Social Media Hub', title: 'Social Media Hub', breadcrumb: '42+ integrated social skills' },
          ]
        },
        {
          label: 'Dev environment', collapsed: true, items: [
            { page: 'vs-coder',      icon: '▸', label: 'VS Coder',      title: 'VS Coder',      breadcrumb: 'Full code editor' },
            { page: 'file-browser',  icon: '▸', label: 'File Browser',  title: 'File Browser',  breadcrumb: 'Browse workspace files' },
            { page: 'script-runner', icon: '▸', label: 'Script Runner', title: 'Script Runner', breadcrumb: 'Run workspace scripts' },
          ]
        },
        {
      ...
      sections: [
        {
          label: 'Admin', collapsed: true, items: [
            ...
            { page: 'people',        icon: '▸', label: 'CRM',           title: 'CRM',           breadcrumb: 'Contact management', enabled: true },
            { page: 'resident-roster', icon: '▸', label: 'Resident Roster', title: 'Resident Roster', breadcrumb: 'Urology residents' },
            { page: 'contacts',      icon: '▸', label: 'Contacts',      title: 'Contacts',      breadcrumb: 'Contact directory' },
            { page: 'crm-audit',     icon: '▸', label: 'CRM Audit',     title: 'CRM Audit',     breadcrumb: 'Access log' },
  ...
  hiddenRoutes: [
    ...
    { page: 'calendar2',          icon: '▸', label: 'Calendar v2',        title: 'Calendar v2',        breadcrumb: 'Alternate calendar build', hidden: true },
  ],
